    ...
    >
      ...
      `}>
        ...
        <p className="text-xs text-zinc-500 mb-6 leading-relaxed">
          ...
          <br />
          <span className="opacity-70 text-[10px]">🔒 Your key is stored only in your browser and sent directly to Google Gemini. It is never transmitted to any other server.</span>
        </p>
